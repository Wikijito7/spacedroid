...
public class Assets {
	...
	//Creo un void estatico que se ejecutar� al abrir la ventana del juego para obtener todas las imagenes y tenerlas a mano para cuando se necesiten.
	public static void init() {
		//Defino d�nde est� y c�mo es el spritesheet.
		...
		//Indico el tama�o de la matriz de la imagen en si, por ejemplo explosion, en este caso 6
		//Ships
		...
		//El shipss.getImage(int, int) da la imagen exacta en esa posici�n. Empieza por 0 y acaba en 9 en imagenes donde las tiles son de 10x10
