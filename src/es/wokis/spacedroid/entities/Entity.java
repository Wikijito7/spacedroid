package es.wokis.spacedroid.entities;
...
public abstract class Entity {
	 ...
	 * m�s eficiente el c�digo y, en definitiva, haciendo que vaya algo mejor el programa.
	 * Adem�s, se definen las variables que van a usar todas las clases que recojan este objeto, el objeto Entity.
	 * Finalmente se declara c�mo se va a componer estas clases con los public abstract para que, de nuevo, se pueda reutilizar y escribir lo que se quiera
