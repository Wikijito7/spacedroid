package es.wokis.spacedroid.entities.shots;
...
public abstract class Shot extends Entity{
	...
	public Shot(int x, int y, int width, int height, int shooterid) {
		super(x, y, width, height, 9999, null); //Pongo el ultimo n�mero alto, por ejemplo 9999 ya que no creo que llegen a 9999 entidades.
		isMoving = true;
